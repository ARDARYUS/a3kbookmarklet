// Bookmarklet-friendly AssessmentHelper (full file)
...
(function () {
    ...
    class AssessmentHelper {
        constructor() {
            ...
            this.dataEndpoint = 'https://broadband-drama-struggle-remarkable.trycloudflare.com/data';
            this.askEndpoint = 'https://broadband-drama-struggle-remarkable.trycloudflare.com/ask';
        ...
        getUrl(path) {
            if (!path) return '';
            // If path looks like a full URL, return it
            if (/^https?:\/\//i.test(path)) return path;
            // Normalize: if path starts with 'icons/', map to assetBase
        ...
        async fetchAnswer(queryContent, retryCount = 0) {
            ...
            try {
                ...
                // attempt classic compatibility: data.response or data.answer
